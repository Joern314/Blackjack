...
// Wird fÃ¼r jede ankommende Nachricht aufgerufen
...
// Erstellt einen HTML-Knoten fÃ¼r diese Nachricht
...
// Stellt eine Nachricht als HTML dar (Version fÃ¼r groÃŸe Bildschrime)
...
// Stellt eine Nachricht als HTML dar (Version fÃ¼r kleine Bildschrime)
...
//Sorgt dafÃ¼r dass auf mobilen GerÃ¤ten nach Ã–ffnen der Tastatur
...
// Generiert die anzeigten Posts neu (z.B. falls Einstellungen geÃ¤ndert werden)
...
function InitSettings()
{
	...
	skinSelect.add(new Option("ApfelweiÃŸ", 'apfelweiss'));
	skinSelect.value = options['skin'];

	var layoutSelect = confPart.getElementById('layout');
	layoutSelect.add(new Option("fÃ¼r Bildschirme", 'screen'));
...
// FÃ¼r das Herunterladen und Anzeigen des Chatlogs
...
{
	return text.replace (/(https:\/\/|http:\/\/|ftp:\/\/)([\wÃ¤Ã¼Ã¶ÃŸÃ„ÃœÃ–\&.~%\/?#=@:\[\]+\$\,-;!]*)/g,
...
// LÃ¤dt Mathjax - Erstmal nur zum Testen
...
// LÃ¤sst MathJax nochmal rÃ¼berlaufen
